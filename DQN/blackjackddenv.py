...
class BlackjackEnv(gym.Env):
    ...
    def __init__(self, numdecks = 6, natural=False, counting = False):
        print('HELLO')
    ...
    def _step(self, action):
        ...
        return self._get_obs(), reward * self.bet, done, out_of_deck, ddown

    def _get_obs(self, show_dealer= False):
        ...
        if self.counting:
            return sum_hand(self.player), dealer, usable_ace(self.player), can_double_down(self.player,  self.actionstaken), self.running_count
